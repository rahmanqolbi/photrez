...
Base error codes are defined in `docs/15-command-contract-spec.md`.
UI message format follows `docs/28-ui-copy-guidelines.md`.
...
- Error codes must match `docs/15-command-contract-spec.md`.
- User messages must follow `docs/28-ui-copy-guidelines.md` format.
