...
| Area | Keputusan | Status |
| ---- | --------- | ------ |
| Brush/eraser footprint boundary | `Size / 2` is the sole support radius for every hardness. Runtime alpha is 1 inside `hardness * radius`, feathers with smoothstep to 0 at `radius`, and remains 0 outside. This supersedes the 2026-06-19 soft-tail, visible-edge-alpha, and perceptual-core entries; hardness changes only the profile inside the footprint. | Locked 2026-06-20 |
