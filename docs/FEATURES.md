...
| ✅ DONE      | Smart Guides (Crop Classic) — Snap to document edges, center, rule-of-thirds during drag-create + cyan dashed snap lines |
| ⬜ DESIGN    | Smart Guides (Crop Modern) — Same snap + snap line rendering for Modern mode |
